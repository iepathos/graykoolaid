...
response.title = T('iamsunmaid.com - dried fruit for the soul')
response.subtitle = T('We want to know how you like your raisins!')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Glen Baker <glen.b.baker@gmail.com>'
response.meta.description = 'iamsunmaid.com '
response.meta.keywords = 'raisins, sunmaid, commercial, wyoma films, glen baker, chris guerrero, ken kouot, california, produce, web2py, python, framework'
